...
exports.ProcessContactDeletePage =
  exports.ProcessContactEditPage =
  exports.DisplayContactingEditPage =
  exports.DisplayContactingListPage =
    void 0;
const contacting_1 = __importDefault(require("../Models/contacting"));
const Util_1 = require("../Util");
function DisplayContactingListPage(req, res, next) {
  contacting_1.default.find(
    {},
    null,
    { sort: { name: 1 } },
...
function ProcessContactEditPage(req, res, next) {
  ...
  contacting_1.default.updateOne(
    { _id: id },
    updatedContactingItem,
    {},
    (err) => {
      if (err) {
        console.error(err);
